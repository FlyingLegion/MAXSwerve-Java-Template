...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kTrackWidth = Units.inchesToMeters(26.5); //Must update
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = Units.inchesToMeters(26.5); //Must update
  ...
  public static final class IntakeConstants {
    public static final int kIntakeMovementMotorID = 22; 
    public static final int kIntakeWheelsMotorID = 21; 
  }
}
